        ...
        public static void ZombieAttack()
        {
            ...
            if (randomNumber == 0)
            {
                while (zombieLoop)
                {
                    ...
                    Console.WriteLine("In a moment of panic, you desperately search inside your inventory for something to use as a weapon.");
        ...
        public static void Help(string answer)
        {
            ...
            switch (answer)
            {
                ...
                case "info":
                    ...
                    Console.WriteLine("Bear in mind that these are just a few, feel free to experiment.");
                    anythingElseCondition = false;
                    break;
            }
